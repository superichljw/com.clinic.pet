...
<body>
	...
	<form action="./faq_update" method="post"
		...
		<div>
			...
			<table class="boardViewTable">
				...
				<tr>
					<th>제목</th>
					<td colspan="5"><input type="text" name="faq_title" size="101"
				...
				<tr>
					...
					<td colspan="3"><textarea cols="100" rows="20" id="content"
							name="faq_content" class="table-content">${faqVo.faq_content }</textarea></td>

...
<body>
	...
	<div>
		...
		<form name="frm"  action="./faq_write" method="post"
			enctype="multipart/form-data">
			<table class="boardWriteTable">
				<tr>
					<th>작성자</th>
					<td><input type="text" name="faq_name" class="table-name" value="관리자"
						size="60"> * 필수</td>
				</tr>

				<tr>
					<th>제목</th>
					<td><input type="text" size="101" name="faq_title"
						class="table-title"> * 필수</td>
				</tr>
				<tr>
					<th>내용</th>
					<td><textarea cols="100" rows="20" name="faq_content"

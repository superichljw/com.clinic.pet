...
<body>
	...
	<div>
		...
		<form name="frm" action="./notice_write" method="post"
			enctype="multipart/form-data">
			<table class="boardWriteTable">
				<tr>
					<th>작성자</th>
					<td><input type="text" name="notice_name" class="table-name"
						value="관리자" size="60" readonly> * 필수</td>
				</tr>

				<tr>
					<th>제목</th>
					<td><input type="text" size="101" name="notice_title"
						class="table-title"> * 필수</td>
				</tr>
				<th>내용</th>
				<td><textarea cols="100" rows="20" name="notice_content"
						id="content"></textarea></td>
				</tr>
			</table>
			<br> <br>
			<div class="boardButtons">
				<input type="button" value="등 록" onclick="updateSe();"
					class="boardBtnApply"

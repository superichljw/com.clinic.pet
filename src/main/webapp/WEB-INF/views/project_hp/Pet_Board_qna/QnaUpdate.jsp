	...
	<form action="./qna_update">
		<div>
			...
			<table class="boardViewTable">
				...
				<tr>
					<th>제목</th>
					<td colspan="5"><input type="text" name="qna_title" size="101"
						value="${qnaVo.qna_title }"></td>
				...
				<tr>
					...
					<td colspan="3"><textarea cols="100" rows="20" id="content"
							name="qna_content" class="table-content">${qnaVo.qna_content }</textarea></td>
			...
			<div class="boardViewBtn">
				...
				<input type="submit" value="게시글 수정"
					onclick="updateSe()" class="boardViewBtnUpdate"> 
					<input
